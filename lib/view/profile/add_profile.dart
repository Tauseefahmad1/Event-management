                ...
                textField(
                    ...
                    validator: (String input) {
                      if (locationController.text.isEmpty) {
                        Get.snackbar('Warning', 'Please Enter Your Location.',
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }

                      if (locationController.text.length < 10) {
                        Get.snackbar(
                            'Warning', 'Enter Complete Location Please.',
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
